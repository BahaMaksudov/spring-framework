...
public interface EmployeeRepository extends JpaRepository<Employee,Long> {
    ...
    //Derived query - is good as long as they are not complex
    ...
    List<Employee> getAllEmployeesFirstName(String name);
    ...
    List<Employee> readEmployeeSalary(@Param("salary") int salary);
